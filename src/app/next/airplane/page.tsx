      ...
      <div className="w-full max-w-lg mx-auto">
        <form className="bg-white rounded-3xl shadow-2xl px-8 py-10 animate-fade-in-card border border-blue-100" onSubmit={handleSubmit}>
          <div className="flex flex-col items-center mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-blue-700 mb-2 text-center tracking-tight">Airplane - Customer Information</h2>
            <div className="w-16 h-1 bg-blue-200 rounded-full mb-2"></div>
            <p className="text-gray-500 text-center text-sm">Fill in your details to book your airplane journey with Next Stops.</p>
          </div>
          ...
          <button type="submit" className="w-full py-3 bg-gradient-to-r from-blue-500 to-blue-700 text-white font-bold rounded-xl shadow-lg hover:scale-105 hover:from-blue-600 hover:to-blue-800 transition-transform duration-200 cursor-pointer text-lg">Book Airplane Ticket</button>
        </form>
      </div>
    </main>
  );
