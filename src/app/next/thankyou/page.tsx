...
export default function ThankYouPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8 bg-gray-50">
      ...
      <button
        className="mt-4 px-6 py-2 bg-green-600 text-white rounded-md shadow-md hover:bg-green-500 cursor-pointer"
        onClick={() => window.location.href = "/"}
      >
        Go Back Home
      </button>
      <div className="mt-8 text-center">
        <span className="block text-xl font-extrabold text-blue-700 tracking-wide">Your Journey Our Priority</span>
      </div>
    </main>
  );
}
